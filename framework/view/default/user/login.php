                ...
                <div id="content_inside">
                    <div id="main_block">
                        <div class="news">
                            ...
                            <BR><a <?php $forgotpasswordURL = \phpsec\HttpRequest::Protocol() . "://" . \phpsec\HttpRequest::Host() . \phpsec\HttpRequest::PortReadable() . "/rnj/framework/forgotpassword"; echo "href='{$forgotpasswordURL}'"; ?> >Forgot Password</a> <br> Click Here to recover your access to account in case you have forgot your password.
